	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prev_updown action-prev'></div>" :
				"<div class='prev_updown action-next'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='next_updown action-next'></div>" :
				"<div class='next_updown action-prev'></div>";
			...
			inputs.on('keydown', function(e) {
				...
				if (e.which === 38) {
					if (settings.increase_direction === 'down') {
						direction = 'prev_updown';
					} else {
						direction = 'next_updown';
					}
				// DOWN
				} else if (e.which === 40) {
					if (settings.increase_direction === 'down') {
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next')) || direction === 'next_updown') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev')) || direction === 'prev_updown') {
